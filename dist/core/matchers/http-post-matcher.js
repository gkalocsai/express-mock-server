...
exports.matchRecordPost = void 0;
 ...
 */
const matchRecordPost = (req, bundle) => {
  let matches = (0, _queryStringMatcher.getMatchesByQueryString)(req, bundle);
  matches.sort((a, b) => {
    return b.result.compare(a.result);
  });
  let requestBody = req.body; // console.log('***********');
  ...
  matches.forEach(({
    ...
    if (!!body) {
          ...
          case 'REGEX':
            {
              ...
              var result = str.match(re); // console.log('+++++++++++++');
              // console.log(str);
              // console.log(value);
              // console.log(result);
          ...
          case 'JSON':
            {
              ...
              if (body.matchType && body.matchType === 'ONLY_MATCHING_FIELDS') {
                let recordBodyValue = JSON.parse(body.value); // let requestBodyKeysLength = Object.keys(requestBody).length;
      ...
      let isRequestBodyEmpty = !requestBody || JSON.stringify(requestBody) === '{}'; // console.log('ELSE');
...
exports.matchRecordPost = matchRecordPost;
//# sourceMappingURL=http-post-matcher.js.map